...
SELECT
    ...
    (SELECT "id" FROM "CREDIT_PACKAGE" WHERE "name"='14 堂組合包方案') AS "credit_package_id",
    (SELECT "credit_amount" FROM "CREDIT_PACKAGE" WHERE "name"='14 堂組合包方案') AS "purchased_credits",
    (SELECT "price" FROM "CREDIT_PACKAGE" WHERE "name"='14 堂組合包方案') AS "price_paid"
UNION ALL
SELECT
    (SELECT "id" FROM "USER" WHERE "name"='王小明') AS "user_id",
    (SELECT "id" FROM "CREDIT_PACKAGE" WHERE "name"='21 堂組合包方案') AS "credit_package_id",
    (SELECT "credit_amount" FROM "CREDIT_PACKAGE" WHERE "name"='21 堂組合包方案') AS "purchased_credits",
    (SELECT "price" FROM "CREDIT_PACKAGE" WHERE "name"='21 堂組合包方案') AS "price_paid"
UNION ALL
SELECT
    (SELECT "id" FROM "USER" WHERE "name"='好野人') AS "user_id",
    (SELECT "id" FROM "CREDIT_PACKAGE" WHERE "name"='14 堂組合包方案') AS "credit_package_id",
    (SELECT "credit_amount" FROM "CREDIT_PACKAGE" WHERE "name"='14 堂組合包方案') AS "purchased_credits",(SELECT "price" FROM "CREDIT_PACKAGE" WHERE "name"='14 堂組合包方案') AS "price_paid";
...
INSERT INTO "COACH" ("user_id", "experience_years", "created_at", "updated_at")
VALUES
    ((SELECT "id" FROM "USER" WHERE "email"='lee2000@hexschooltest.io'), 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ((SELECT "id" FROM "USER" WHERE "email"='muscle@hexschooltest.io'), 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ((SELECT "id" FROM "USER" WHERE "email"='starplatinum@hexschooltest.io'), 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
VALUES
    ((SELECT "id" FROM "COACH" WHERE "user_id"=(SELECT "id" FROM "USER" WHERE "email"='lee2000@hexschooltest.io')),
        (SELECT "id" FROM "SKILL" WHERE "name"='重訓'), CURRENT_TIMESTAMP),
   ...
   ((SELECT "id" FROM "COACH" WHERE "user_id"=(SELECT "id" FROM "USER" WHERE "email"='starplatinum@hexschooltest.io')),
        (SELECT "id" FROM "SKILL" WHERE "name"='重訓'), CURRENT_TIMESTAMP),
    ((SELECT "id" FROM "COACH" WHERE "user_id"=(SELECT "id" FROM "USER" WHERE "email"='muscle@hexschooltest.io')),
        (SELECT "id" FROM "SKILL" WHERE "name"='瑜伽'), CURRENT_TIMESTAMP),
    ((SELECT "id" FROM "COACH" WHERE "user_id"=(SELECT "id" FROM "USER" WHERE "email"='starplatinum@hexschooltest.io')),
        (SELECT "id" FROM "SKILL" WHERE "name"='有氧運動'), CURRENT_TIMESTAMP),
    ((SELECT "id" FROM "COACH" WHERE "user_id"=(SELECT "id" FROM "USER" WHERE "email"='starplatinum@hexschooltest.io')),
        (SELECT "id" FROM "SKILL" WHERE "name"='復健訓練'), CURRENT_TIMESTAMP);
---------------------------------------------------------------------------------------------
-- 3-3 修改：更新教練的經驗年數，資料需求如下：
    -- 1. 教練`肌肉棒子` 的經驗年數為3年
    -- 2. 教練`Q太郎` 的經驗年數為5年
UPDATE "COACH"
SET "experience_years"=3, "updated_at"=CURRENT_TIMESTAMP
WHERE "user_id"=(SELECT "id" FROM "USER" WHERE "email"='muscle@hexschooltest.io');

UPDATE "COACH"
SET "experience_years"=5, "updated_at"=CURRENT_TIMESTAMP
WHERE "user_id"=(SELECT "id" FROM "USER" WHERE "email"='starplatinum@hexschooltest.io');
---------------------------------------------------------------------------------------------
-- 3-4 刪除：新增一個專長 空中瑜伽 至 SKILL 資料表，之後刪除此專長。
INSERT INTO "SKILL" ("name", "created_at") 
VALUES ('空中瑜伽', CURRENT_TIMESTAMP);
...
INSERT INTO "COURSE" ("user_id", "skill_id", "name", "description", "start_at", "end_at", "max_participants", "meeting_url", "created_at")
VALUES
    ((SELECT "id" FROM "USER" WHERE "email" = 'lee2000@hexschooltest.io'),
        (SELECT "id" FROM "SKILL" WHERE "name" = '重訓'), '重訓基礎課', NULL, '2024-11-25 14:00:00', '2024-11-25 16:00:00', 10, 'https://test-meeting.test.io', CURRENT_TIMESTAMP
    );
